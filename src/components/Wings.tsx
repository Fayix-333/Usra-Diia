    ...
    <section id="wings" className="relative py-28 bg-[#050505]">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-6xl">
                  ...
                  <div className="space-y-3 pt-2">
                    ...
                    <div className="space-y-2">
                      {activeWing.details.map((detail, idx) => (
                        <div key={`${activeWing.id}-detail-${idx}`} className="flex items-start gap-3">
                  ...
                  <div className="p-6 rounded-[28px] border border-white/5 bg-neutral-950/60 relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {activeWing.members.map((member, idx) => (
                        <div 
                          key={`${activeWing.id}-member-${member.name}-${idx}`} 
        ...
        <motion.div 
          ...
          className="text-center mb-16 pt-16 border-t border-white/5"
        >
          <motion.p 
            variants={staggerHeaderVariants}
            className="font-mono text-[10px] uppercase tracking-[0.3em] text-cyan-400 font-bold mb-3"
          >
            REJUVENATED ACTIVIST NETWORK
          </motion.p>
          <motion.h3 
            variants={staggerHeaderVariants}
            className="font-display font-black text-3xl md:text-5xl text-white tracking-tight uppercase"
          >
            BUREAU FOR REJUVENATED ACTIVITIES
          </motion.h3>
          <motion.p 
            variants={staggerHeaderVariants}
            className="font-mono text-xs text-neutral-400 uppercase tracking-widest mt-2"
          >
            USRA Social Reformation Association Bureau
          </motion.p>
          <motion.div 
            variants={staggerHeaderVariants}
            className="h-1 bg-gradient-to-r from-cyan-500 to-blue-500 w-16 mx-auto mt-4 rounded-full" 
          />
        </motion.div>
