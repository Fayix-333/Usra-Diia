...
import { staggerContainerVariants, staggerItemVariants, staggerCardVariants, staggerHeaderVariants } from '../animations';
    ...
    <section id="contact" className="relative py-28 bg-[#050505] overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-5xl">
        ...
        <motion.div 
          ...
          className="glass-panel-heavy rounded-3xl overflow-hidden grid grid-cols-1 md:grid-cols-12 relative shadow-2xl border-white/10"
        >
          {/* Top gloss */}
          ...
          <motion.div 
            ...
            className="md:col-span-5 p-8 md:p-12 border-b md:border-b-0 md:border-r border-white/5 flex flex-col justify-between relative bg-neutral-950/40"
          >
            <div>
          ...
          <motion.div 
            variants={staggerCardVariants}
            className="md:col-span-7 p-8 md:p-12 relative bg-neutral-900/10"
          >
