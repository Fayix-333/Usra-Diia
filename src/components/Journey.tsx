    ...
    <section id="journey" className="relative py-28 bg-[#030303] overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-5xl">
        ...
        <motion.div 
          ...
          className="relative space-y-16 before:absolute before:top-0 before:bottom-0 before:left-4 md:before:left-1/2 before:-translate-x-1/2 before:w-[2px] before:bg-gradient-to-b before:from-blue-600/20 before:via-white/5 before:to-cyan-400/20"
        >
                      ...
                      <div className="space-y-3 border-t border-white/5 pt-4">
                        ...
                        <ul className="space-y-2">
                          {item.highlights.map((highlight, index) => (
                            <li key={`${item.id}-highlight-${index}`} className="flex items-start gap-2.5 text-xs text-neutral-400 group-hover:text-neutral-300 transition-colors duration-300">
