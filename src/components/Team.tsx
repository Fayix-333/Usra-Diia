    ...
    <section id="team" className="relative py-28 bg-[#050505] overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-6xl">
        ...
        <motion.div 
          ...
          whileInView="animate"
          viewport={{ once: true, margin: '-60px' }}
          className="text-center mb-16 pt-8 border-t border-white/5"
        >
          <motion.p 
            variants={staggerHeaderVariants}
        ...
        <motion.div 
          ...
          whileInView="animate"
          viewport={{ once: true, margin: '-60px' }}
          className={webCreators.length === 1 ? "flex justify-center" : "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8"}
        >
          {webCreators.map((member) => (
            <motion.div
              key={member.id}
              variants={staggerCardVariants}
              whileHover={{ y: -8, scale: 1.025 }}
