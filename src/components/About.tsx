...
import { staggerContainerVariants, staggerCardVariants, staggerHeaderVariants } from '../animations';
  ...
  return (
    <section id="about" className="relative py-28 overflow-hidden bg-[#030303]">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-6xl">
        ...
        >
          <motion.p
            variants={staggerHeaderVariants}
          ...
          <motion.div
            variants={staggerHeaderVariants}
            className="h-1 bg-gradient-to-r from-blue-600 to-cyan-400 w-20 mx-auto mt-6 rounded-full"
          />
        </motion.div>
        ...
        <motion.div 
          ...
          className="relative border-l border-white/5 md:border-l-0 md:grid md:grid-cols-2 md:gap-x-12 md:gap-y-16 md:before:absolute md:before:top-0 md:before:bottom-0 md:before:left-1/2 md:before:-translate-x-1/2 md:before:w-px md:before:bg-gradient-to-b md:before:from-blue-600/20 md:before:via-white/10 md:before:to-cyan-400/20"
        >
                  ...
                  {item.details && (
                    <ul className="space-y-2 text-xs text-neutral-500 border-t border-white/5 pt-4">
                      {item.details.map((detail, idx) => (
                        <li key={`${item.id}-detail-${idx}`} className="flex items-start gap-2">
        ...
        <div id="members-registry" className="mt-32 pt-20 border-t border-white/5">
          ...
          >
            ...
            <motion.div
              variants={staggerHeaderVariants}
              className="h-1 bg-gradient-to-r from-cyan-500 to-blue-500 w-20 mx-auto mt-4 rounded-full"
            />
          </motion.div>
